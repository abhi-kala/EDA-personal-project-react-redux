...
## Abhi Personal project workflow:

#### Commits:

* 1st Commit
  - created a store in Index.js
  - created a reducer with the initial state
  - created the JobsListContainer to connect the state to the functional component
  - created the first functional component - jobsList
